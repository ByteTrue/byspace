...
BySpace는 기본적으로 `127.0.0.1:6777`에서 시작합니다. 암호화 릴레이를 활성화하거나 TCP, Tailscale 또는 다른 VPN으로 직접 연결할 수 있습니다.

자세한 설치와 설정은 아래 문서를 참고하세요.

- [개발 및 설치](docs/development.md)
- [아키텍처](docs/architecture.md)
- [Server 및 CLI 레퍼런스](packages/server/README.md)
...
자세한 내용은 [Server 및 CLI 레퍼런스](packages/server/README.md)를 참고하세요.
