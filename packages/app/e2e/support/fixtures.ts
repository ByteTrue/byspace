  ...
  e2eWorker: [
    async (
      ...
      const worker = await startE2EWorker(workerInfo.workerIndex, {
        ...
        injectBySpaceTools: e2eInjectBySpaceTools,
      });
      try {
        await provide();
      } finally {
