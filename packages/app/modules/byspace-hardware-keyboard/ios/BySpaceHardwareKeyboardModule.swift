...
private weak var activeModule: BySpaceHardwareKeyboardModule?
private var isHardwareSubmitEnabled = false

@objc
public class BySpaceHardwareKeyboardReactDelegateHandler: ExpoReactDelegateHandler {
  public override func createRootViewController() -> UIViewController? {
    return BySpaceHardwareKeyboardRootViewController()
  }
}

public class BySpaceHardwareKeyboardModule: Module {
  public func definition() -> ModuleDefinition {
    Name("BySpaceHardwareKeyboard")
...
private final class BySpaceHardwareKeyboardRootViewController: UIViewController {
  ...
  private func canSubmitCurrentTextInput() -> Bool {
    guard let responder = UIResponder.byspaceCurrentFirstResponder else {
      return false
    }
...
private extension UIResponder {
  ...
  static var byspaceCurrentFirstResponder: UIResponder? {
