...
export const es: TranslationResources = {
  ...
  newWorkspace: {
    ...
    refPicker: {
      ...
      updateHost: "Actualiza el host para usar esta función.",
  ...
  addProjectFlow: {
    accessibility: "Añadir proyecto: {{page}}",
    back: "Atrás",
    openPath: "Abrir ruta",
    loading: "Cargando…",
    progress: {
      clone: "Clonando repositorio…",
      create: "Creando directorio…",
      add: "Añadiendo proyecto…",
    },
    empty: {
    ...
    errors: {
      ...
      githubSearch: "No se puede buscar en GitHub",
      githubUnavailable: "La búsqueda de repositorios de GitHub no está disponible",
      directoryNotFound: "Directorio no encontrado",
      add: "No se puede añadir el proyecto",
      clone: "No se puede clonar el repositorio",
      nameRequired: "Introduce un nombre de directorio sin barras",
      create: "No se puede crear el directorio",
    },
    titles: {
      host: "Elige un host",
      method: "¿Cómo quieres añadirlo?",
      directory: "Buscar un directorio",
      github: "Elige un repositorio de GitHub",
      destination: "Elige el destino",
      parent: "Elige el directorio padre",
      name: "Nombra el nuevo directorio",
      addHost: "Añadir un host",
    },
    placeholders: {
      host: "Buscar hosts…",
      method: "Buscar métodos…",
      directory: "Escribe una ruta o busca directorios…",
      github: "Busca en GitHub o introduce owner/repo…",
      parent: "Buscar directorios padre…",
      name: "Nombre del directorio",
    },
    methods: {
      directory: { label: "Buscar directorio", description: "Buscar un directorio en {{host}}" },
      browse: { label: "Explorar", description: "Elegir un directorio local" },
      github: {
        label: "Clonar desde GitHub",
        update: "Actualiza este host para clonar repositorios de GitHub",
        search: "Buscar tus repositorios de GitHub",
        enter: "Introduce una URL de repositorio u owner/repo",
      },
      newDirectory: {
        label: "Nuevo directorio",
        description: "Crear un proyecto vacío en {{host}}",
        update: "Actualiza este host para crear directorios",
      },
    },
    repository: {
      url: "URL del repositorio",
      cloneVia: "Clonar mediante {{protocol}}",
      via: "{{repository}} mediante {{protocol}}",
    },
    destination: {
      exists: "Ya existe",
      parent: "Directorio padre: {{parent}}",
      useParent: "Usar este directorio padre",
    },
    hints: { navigate: "Navegar", select: "Seleccionar", back: "Atrás", close: "Cerrar" },
  },
  projectPicker: {
