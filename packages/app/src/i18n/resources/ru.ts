  ...
  settings: {
    ...
    providers: {
      ...
      terminal: {
        ...
        defaultShell: {
          sectionTitle: "Терминал по умолчанию",
          label: "Shell по умолчанию",
          hint: "Используется при создании нового Terminal без профиля",
          accessibilityLabel: "Shell по умолчанию: {{value}}",
          saving: "Сохранение...",
          options: {
