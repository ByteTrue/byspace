...
export const ru: TranslationResources = {
  ...
  pairing: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Узнать, как работает ретранслятор BySpace",
  ...
  toolCallGroup: {
    ...
    byspaceCalls: {
      one: "выполнен {{count}} вызов BySpace",
      other: "выполнены вызовы BySpace ({{count}})",
    },
    and: "и",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "BySpace передал уведомление операционной системе.",
      sendFailedTitle: "Не удалось отправить тестовое уведомление",
      webPush: {
        title: "Уведомления браузера",
        description:
          "Получайте уведомление, когда агент завершил работу или ждёт вас, даже если вкладка закрыта.",
        enable: "Включить",
        enabling: "Включение…",
        disable: "Отключить",
        disabling: "Отключение…",
        unsupported: "Этот браузер не может получать push-уведомления.",
        iosHomeScreenHint:
          "На iPhone и iPad сначала добавьте BySpace на экран «Домой». Вкладки Safari не получают push-уведомления.",
        state: {
          enabled: "Включены в этом браузере.",
          prompt: "Выключены. Включите, чтобы разрешить уведомления.",
          denied: "Заблокированы. Разрешите уведомления для этого сайта в настройках браузера.",
          unavailable: "Этот хост не поддерживает уведомления браузера.",
          unsupported: "Этот браузер не может получать push-уведомления.",
        },
      },
    },
    ...
    metadataGeneration: {
      ...
      description:
        "Выберите модель, которую BySpace будет использовать для названий рабочих пространств и веток, сообщений коммитов и черновиков PR",
      selection: "Выбор модели",
      automatic: "Автоматически",
      preferred: "Вручную",
      automaticHint: "BySpace выбирает быструю доступную модель",
      preferredHint: "Выберите модель, которую использует BySpace",
      model: "Модель",
      fallbackHint: "Если она недоступна, BySpace использует другую доступную модель",
      docs: "Документация",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "Вкладки браузера в BySpace используют общие данные входа и данные сайтов.",
    ...
    host: {
      ...
      orchestration: {
        ...
        enableTools: {
          ...
          accessibilityLabel: "Добавить инструменты BySpace",
        },
        systemPrompt: {
      ...
      daemon: {
        ...
        network: {
          sectionTitle: "Сеть",
          unavailable: "Подключитесь к этому хосту, чтобы управлять настройками сети",
          saveError: "Не удалось обновить настройки сети",
          restartHint: "Перезапустите daemon, чтобы применить изменения сети",
          restartPrompt: {
            title: "Перезапустить daemon сейчас?",
            message:
              "Изменения сети вступят в силу после перезапуска. Приложение переподключится автоматически.",
            confirm: "Перезапустить сейчас",
            later: "Позже",
            failedTitle: "Не удалось перезапустить daemon",
          },
          password: {
            title: "Пароль доступа",
            setHint: "Установлен — другим устройствам потребуется указать его при подключении",
            unsetHint: "Не установлен — любое устройство сети может подключиться без него",
            edit: "Изменить",
            sheetTitle: "Пароль доступа",
            fieldLabel: "Пароль",
          ...
          allowLan: {
            title: "Разрешить подключения по LAN",
            hint: "Устройства этой сети могут подключаться к daemon через порт {{port}}",
        ...
        update: {
          desktopManagedHint:
            "Этот демон управляется BySpace Desktop. Обновите BySpace Desktop на хосте.",
    ...
    project: {
      ...
      readFailures: {
        invalidTitle: "Не удалось разобрать конфигурацию проекта",
        invalidDescription: "Исправьте файл на диске, затем загрузите его заново.",
        conflictingDescription:
          "Одновременно существуют byspace.json и устаревший {{legacyFileName}}. Оставьте только один файл и перезагрузите.",
        missingTitle: "У этого хоста нет этого проекта",
        missingSingleHost: "У выбранного хоста нет записей об этом проекте.",
        transportTitle: "Не удалось загрузить конфигурацию проекта.",
      ...
      worktree: {
        ...
        uncommittedTitle: "Закоммитьте изменения конфигурации проекта",
      ...
      writeFailures: {
        ...
        staleDescription:
          "Перед сохранением загрузите с диска последнюю версию конфигурации проекта.",
        failedTitle: "Не удалось сохранить конфигурацию проекта.",
        failedDescription: "Повторите попытку или загрузите с диска последнюю версию.",
      },
      actions: {
