...
export const ru: TranslationResources = {
  ...
  newWorkspace: {
    ...
    refPicker: {
      ...
      updateHost: "Обновите хост, чтобы использовать эту функцию.",
  ...
  addProjectFlow: {
    accessibility: "Добавить проект: {{page}}",
    back: "Назад",
    ...
    errors: {
      ...
      githubSearch: "Не удалось выполнить поиск в GitHub",
      githubUnavailable: "Поиск репозиториев GitHub недоступен",
      directoryNotFound: "Каталог не найден",
      add: "Не удалось добавить проект",
      clone: "Не удалось клонировать репозиторий",
      nameRequired: "Введите имя каталога без косых черт",
      create: "Не удалось создать каталог",
    },
    titles: {
      host: "Выберите хост",
      method: "Как добавить проект?",
      directory: "Найти каталог",
      github: "Выберите репозиторий GitHub",
      destination: "Выберите назначение",
      parent: "Выберите родительский каталог",
      name: "Назовите новый каталог",
      addHost: "Добавить хост",
    },
    placeholders: {
      host: "Поиск хостов…",
      method: "Поиск способов…",
      directory: "Введите путь или найдите каталог…",
      github: "Поиск в GitHub или ввод owner/repo…",
      parent: "Поиск родительских каталогов…",
      name: "Имя каталога",
    },
    methods: {
      directory: { label: "Найти каталог", description: "Найти каталог на {{host}}" },
      browse: { label: "Обзор", description: "Выбрать локальный каталог" },
      github: {
        label: "Клонировать из GitHub",
        update: "Обновите хост для клонирования репозиториев GitHub",
        search: "Искать в ваших репозиториях GitHub",
        enter: "Введите URL репозитория или owner/repo",
      },
      newDirectory: {
        label: "Новый каталог",
        description: "Создать пустой проект на {{host}}",
        update: "Обновите хост для создания каталогов",
      },
    },
    repository: {
      url: "URL репозитория",
      cloneVia: "Клонировать через {{protocol}}",
      via: "{{repository}} через {{protocol}}",
    },
    destination: {
      exists: "Уже существует",
      parent: "Родительский каталог: {{parent}}",
      useParent: "Использовать этот каталог",
    },
    hints: { navigate: "Навигация", select: "Выбрать", back: "Назад", close: "Закрыть" },
  },
  projectPicker: {
