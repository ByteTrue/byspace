  ...
  settings: {
    ...
    host: {
      ...
      daemon: {
        ...
        network: {
          sectionTitle: "网络",
          unavailable: "连接到该主机后可管理网络设置",
          saveError: "无法更新网络设置",
          restartHint: "重启 daemon 后网络设置才会生效",
          restartPrompt: {
            title: "现在重启 daemon？",
            message: "网络更改在重启后生效，应用会自动重新连接。",
            confirm: "立即重启",
            later: "稍后",
            failedTitle: "无法重启 daemon",
          },
          password: {
            title: "访问密码",
            setHint: "已设置，其他设备连接时需要提供密码",
            unsetHint: "未设置，网络内设备无需密码即可连接",
            edit: "编辑",
            sheetTitle: "访问密码",
            fieldLabel: "密码",
          ...
          allowLan: {
            title: "允许局域网连接",
            hint: "局域网内设备可通过端口 {{port}} 连接此 daemon",
