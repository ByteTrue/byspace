...
export const zhCN: TranslationResources = {
  ...
  portForwarding: {
    ...
    auto: "自动",
    start: "启动转发",
    needTwoHosts: "需要两台已连接的主机",
    needTwoHostsDescription: "请更新并连接两台主机后使用端口转发。",
    activeForwards: "活动转发",
    noActiveForwards: "暂无活动转发",
    copyAddress: "复制地址",
    stop: "停止转发",
    status: {
      active: "活动",
    ...
    errors: {
      hostRequired: "请选择主机。",
      hostsMustDiffer: "请选择另一台目标主机。",
      invalidPort: "请输入 1 到 65535 之间的端口。",
      sourceUnavailable: "来源主机已断开连接，请重新连接后重试。",
      targetUnavailable: "目标主机已断开连接，请重新连接后重试。",
      updateRequired: "请更新两台主机后使用端口转发。",
      relayDisabled: "请在目标主机上启用 Relay 后重试。",
      invalidOffer: "目标主机返回了无效的配对信息。",
      startFailed: "无法启动转发，请检查两台主机后重试。",
      copyFailed: "无法复制地址，请重试。",
      stopFailed: "无法停止转发，请重试。",
    },
  },
  agentList: {
    fallbackTitle: "新会话",
