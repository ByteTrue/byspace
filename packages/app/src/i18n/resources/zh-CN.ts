...
export const zhCN: TranslationResources = {
  ...
  addProjectFlow: {
    ...
    errors: {
      ...
      githubSearch: "无法搜索 GitHub",
      githubUnavailable: "GitHub 仓库搜索不可用",
      directoryNotFound: "找不到目录",
      add: "无法添加项目",
      clone: "无法克隆仓库",
      nameRequired: "请输入不含斜杠的目录名称",
      create: "无法创建目录",
    },
    titles: {
      host: "选择主机",
    ...
    placeholders: {
      ...
      method: "搜索方式…",
      directory: "输入路径或搜索目录…",
      github: "搜索 GitHub 或输入 owner/repo…",
      parent: "搜索父目录…",
      name: "目录名称",
    },
    methods: {
      ...
      github: {
        label: "从 GitHub 克隆",
        update: "更新此主机以克隆 GitHub 仓库",
        search: "搜索你的 GitHub 仓库",
        enter: "输入仓库 URL 或 owner/repo",
      },
      newDirectory: {
        label: "新建目录",
        description: "在 {{host}} 上创建空项目",
        update: "更新此主机以创建目录",
      },
    },
    repository: {
      url: "仓库 URL",
      cloneVia: "通过 {{protocol}} 克隆",
