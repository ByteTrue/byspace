...
export const zhCN: TranslationResources = {
  ...
  workspace: {
    ...
    fileActions: {
      ...
      download: "下载",
      focusChatFirst: "添加文件前请先聚焦一个对话标签页",
      addToChat: "添加到聊天",
      moreActions: "更多操作",
      newFile: "新建文件",
      newFolder: "新建文件夹",
    ...
    tabs: {
      ...
      confirmations: {
        ...
        archive: "归档",
        unsavedTitle: "未保存的更改",
        unsavedMessage: "此标签页包含尚未保存的更改。关闭后将丢弃这些草稿。",
        closeWithoutSaving: "不保存并关闭",
        bulkUnsaved: "{{count}} 个标签页包含未保存的更改。关闭后将丢弃这些草稿。",
  ...
  sidebar: {
    ...
    workspace: {
      ...
      toasts: {
        ...
        agentRenamePromptCopied: "提示词已复制，请粘贴给最了解此 workspace 的 Agent。",
        agentRenamePromptCopyFailed: "复制提示词失败",
        hostDisconnected: "Host 未连接",
  ...
  panels: {
    ...
    file: {
      ...
      editor: {
        ...
        accessibilityLabel: "{{filename}} 的源代码编辑器",
        saved: "已保存",
        ...
        conflictDescription: "本地缓冲区已保留。请选择要保留的版本。",
        overwrite: "覆盖",
        reload: "重新加载",
        reloadTitle: "从磁盘重新加载？",
        reloadMessage: "你的本地更改将丢失。",
      },
    },
    diff: {
      changesLabel: "更改",
  ...
  settings: {
    ...
    host: {
      ...
      dataRelay: {
        title: "数据中继",
        cardTitle: "数据中继",
        description: "跨主机安全路由加密的私有 Web 服务与开发端口流量。",
        statusNotConfigured: "未配置",
        statusHosting: "中继运行中",
        statusConnected: "已连接到中继",
        summaryHosting: "在此主机监听数据中继：{{listen}}",
        summaryConnected: "已连接到数据中继：{{endpoint}}",
        setup: "配置数据中继",
        editConfig: "修改配置",
        modalTitle: "配置数据中继",
        modalDescription:
          "在 {{host}} 上配置数据平面中继，无需端口映射即可跨主机安全访问本地开发服务。",
        modeHost: "作为中继服务器",
        modeClient: "连接到已有中继",
        modeHostHint:
          "在此主机上运行独立的 Data Relay 服务端。其他主机可通过公网端点或局域网连接此中继。",
        modeClientHint: "将此主机连接到运行在其他机器或 VPS 上的 Data Relay 服务端。",
        listenLabel: "本地监听地址",
        listenHint: "Data Relay 专属监听端口（TCP host:port，如 127.0.0.1:8788）。",
        listenRequired: "作为中继服务器时必须填写本地监听地址。",
        publicEndpointLabel: "公网端点（可选）",
        publicEndpointHint: "通过隧道或反向代理暴露的公网 host:port（如 relay.example.com:443）。",
        connectLocallyTitle: "同时在本地连接此中继",
        connectLocallyHint: "自动将当前主机连接到本地运行的中继服务。",
        endpointLabel: "中继端点",
        endpointHint: "Data Relay 端点（如 relay.example.com:443 或 127.0.0.1:8788）。",
        endpointRequired: "必须填写中继端点。",
        useTlsTitle: "启用 TLS / WSS",
        useTlsHint: "为远程 WebSocket 中继连接启用安全 TLS 加密。",
        accessTokenLabel: "访问令牌 (Access Token)",
        accessTokenPlaceholder: "输入或随机生成访问令牌",
        accessTokenHint: "所有参与连接的主机之间共享的高强度访问密钥。",
        tokenRequired: "必须填写访问令牌。",
        generateToken: "随机生成",
        tokenGenerated: "已生成新的访问令牌",
        tokenCopied: "访问令牌已复制到剪贴板",
        disable: "停用数据中继",
        disableConfirmTitle: "停用数据中继？",
        disableConfirmMessage: "通过此中继建立的所有远程 Web 服务连接将被断开。",
        saveAndApply: "保存并应用",
        saveSuccess: "数据中继配置已保存",
        disabledSuccess: "数据中继已停用",
      },
      remoteWebServices: {
        title: "远程 Web 服务",
        summary: "私有服务",
        ...
        empty: "还没有远程 Web 服务。",
        noOtherHosts: "未连接其他主机。请在 BySpace 中添加另一台主机以访问其本地私有服务。",
        noCompatibleTargets: "请确保另一台主机在线且已配置数据中继。",
        relayNotConfigured: "请先在此主机配置数据中继，再添加服务。",
        updateHost: "更新此主机以使用远程 Web 服务",
        updateHostHint: "此功能需要更新版本的 daemon。",
        addTitle: "添加远程 Web 服务",
        addHint: "在 {{source}} 上创建稳定的 .remote.localhost 地址。",
        nameLabel: "名称",
        namePlaceholder: "home-web",
        targetLabel: "目标主机",
        noTargets: "没有兼容的主机",
        portLabel: "目标端口",
        portHint: "目标主机上的本地 HTTP 端口。",
        nameRequired: "请输入名称。",
      ...
      orchestration: {
        ...
        skills: {
          title: "编排 Skills",
          installHint: "为受支持的编程 Agent 管理与安装 BySpace 内置 Skills",
          ...
          manage: "管理",
          save: "保存",
          modalTitle: "编排 Skills",
          targetsTitle: "安装目标环境",
          targetAgents: "~/.agents/skills（OpenCode、Codex、Pi 等）",
          targetAgentsDesc: "用于 Pi、OpenCode、Codex 等 Agent 的标准 Skills 目录",
          targetClaude: "~/.claude/skills（Claude Code）",
          targetClaudeDesc: "用于 Claude Code 的 Skills 目录",
          skillsTitle: "选择要安装的 Skills",
          selectAll: "全选",
          deselectAll: "取消全选",
          noTargetSelected: "请至少选择一个安装目标环境。",
          noSkillSelected: "请至少选择一个 Skill。",
          descriptions: {
            byspace: "BySpace 核心命令与工作区工具",
            "byspace-advisor": "顾问 Agent（第二意见）",
            "byspace-committee": "委员会 Agent（双 Agent 协同规划）",
            "byspace-handoff": "任务交接 Agent（带上下文移交）",
            "byspace-project-setup": "项目与 byspace.json 配置",
          },
    ...
    providers: {
      ...
      terminal: {
        sectionTitle: "终端",
        activityTitle: "终端活动",
        activityLabel: "上报 Agent 状态",
        activityHint: "显示该 Agent CLI 正在运行或等待输入",
        legacyActivityLabel: "上报所有 Agent CLI 的状态",
        legacyActivityHint: "此主机仅支持一个共享的终端活动设置",
        launchProfiles: "启动配置",
        addProfile: "添加配置",
        profileActions: "{{name}} 操作",
        otherProfiles: "其他终端配置",
        otherProfilesHint: "{{count}} 个未关联 Provider 的配置",
        updateError: "无法更新终端活动设置",
      },
      title: "Providers",
