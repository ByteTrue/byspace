...
export const ar: TranslationResources = {
  ...
  pairing: {
    ...
    device: {
      ...
      relayDocsAccessibility: "اقرأ كيفية عمل تتابع BySpace",
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "سلّم BySpace الإشعار إلى نظام التشغيل.",
    ...
    metadataGeneration: {
      ...
      description:
        "اختر النموذج الذي يستخدمه BySpace لعناوين مساحات العمل وأسماء الفروع ورسائل الالتزام ومسودات طلبات السحب",
      selection: "اختيار النموذج",
      automatic: "تلقائي",
      preferred: "يدوي",
      automaticHint: "يختار BySpace نموذجًا سريعًا متاحًا",
      preferredHint: "اختر النموذج الذي يستخدمه BySpace",
      model: "النموذج",
      fallbackHint: "إذا لم يكن متاحًا، يستخدم BySpace نموذجًا آخر متاحًا",
      docs: "الوثائق",
    ...
    host: {
      ...
      daemon: {
        ...
        network: {
          sectionTitle: "الشبكة",
          unavailable: "اتصل بهذا المضيف لإدارة إعدادات الشبكة",
          saveError: "تعذّر تحديث إعدادات الشبكة",
          restartHint: "أعد تشغيل الخادم لتطبيق تغييرات الشبكة",
          restartPrompt: {
            title: "إعادة تشغيل الخادم الآن؟",
            message: "تسري تغييرات الشبكة بعد إعادة التشغيل. سيعيد التطبيق الاتصال تلقائيًا.",
            confirm: "إعادة التشغيل الآن",
            later: "لاحقًا",
            failedTitle: "تعذّرت إعادة تشغيل الخادم",
          },
          password: {
            title: "كلمة مرور الوصول",
            setHint: "تم التعيين — يلزم تقديم كلمة المرور للاتصال من أجهزة أخرى",
            unsetHint: "غير معينة — يمكن لأي جهاز على الشبكة الاتصال بدونها",
            edit: "تحرير",
            sheetTitle: "كلمة مرور الوصول",
          ...
          allowLan: {
            title: "السماح بالاتصالات من الشبكة المحلية",
            hint: "يمكن للأجهزة على هذه الشبكة الوصول إلى الخادم عبر المنفذ {{port}}",
        ...
        update: {
          desktopManagedHint:
            "يدير BySpace Desktop هذا البرنامج الخفي. حدّث BySpace Desktop على المضيف.",
          title: "Update daemon",
