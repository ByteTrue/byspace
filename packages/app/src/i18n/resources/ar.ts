  ...
  settings: {
    ...
    providers: {
      ...
      terminal: {
        ...
        defaultShell: {
          sectionTitle: "الطرفية الافتراضية",
          label: "Shell الافتراضي",
          hint: "يُستخدم عند إنشاء طرفية جديدة بدون ملف تعريف",
          accessibilityLabel: "Shell الافتراضي: {{value}}",
          saving: "جارٍ الحفظ...",
          options: {
            systemDefault: "افتراضي للنظام",
            powerShell7: "PowerShell 7 (pwsh.exe)",
            windowsPowerShell: "Windows PowerShell",
            commandPrompt: "موجه الأوامر",
            bash: "Bash",
            zsh: "Zsh",
          },
        },
