...
export const ar: TranslationResources = {
  ...
  portForwarding: {
    ...
    newForward: "إعادة توجيه جديدة",
    sourceHost: "المضيف المصدر",
    targetHost: "المضيف الهدف",
    selectHost: "اختيار مضيف",
    noHosts: "لا توجد مضيفات متاحة",
    targetPort: "المنفذ الهدف",
    localPort: "المنفذ المحلي",
    localPortHint: "اختياري",
    auto: "تلقائي",
    start: "بدء إعادة التوجيه",
    needTwoHosts: "يلزم مضيفان متصلان",
    needTwoHostsDescription: "حدّث المضيفين وصِلهما لاستخدام إعادة توجيه المنافذ.",
    activeForwards: "عمليات إعادة التوجيه النشطة",
    noActiveForwards: "لا توجد عمليات إعادة توجيه نشطة",
    copyAddress: "نسخ العنوان",
    stop: "إيقاف إعادة التوجيه",
    status: {
      active: "نشط",
      stopping: "جارٍ الإيقاف",
    },
    errors: {
      hostRequired: "اختر مضيفًا.",
      hostsMustDiffer: "اختر مضيفًا هدفًا مختلفًا.",
      invalidPort: "أدخل منفذًا من 1 إلى 65535.",
      sourceUnavailable: "لم يعد المضيف المصدر متصلًا. أعد توصيله وحاول مرة أخرى.",
      targetUnavailable: "لم يعد المضيف الهدف متصلًا. أعد توصيله وحاول مرة أخرى.",
      updateRequired: "حدّث المضيفين لاستخدام إعادة توجيه المنافذ.",
      relayDisabled: "فعّل Relay على المضيف الهدف وحاول مرة أخرى.",
      invalidOffer: "أعاد المضيف الهدف عرض اقتران غير صالح.",
      startFailed: "تعذر بدء إعادة التوجيه. تحقق من المضيفين وحاول مرة أخرى.",
      copyFailed: "تعذر نسخ العنوان. حاول مرة أخرى.",
      stopFailed: "تعذر إيقاف إعادة التوجيه. حاول مرة أخرى.",
    },
  },
  agentList: {
