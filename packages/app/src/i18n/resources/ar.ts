...
export const ar: TranslationResources = {
  ...
  newWorkspace: {
    ...
    refPicker: {
      ...
      updateHost: "حدّث المضيف لاستخدام هذه الميزة.",
  ...
  addProjectFlow: {
    accessibility: "إضافة مشروع: {{page}}",
    back: "رجوع",
    openPath: "فتح المسار",
    loading: "جارٍ التحميل…",
    progress: {
      clone: "جارٍ استنساخ المستودع…",
      create: "جارٍ إنشاء المجلد…",
      add: "جارٍ إضافة المشروع…",
    },
    empty: {
    ...
    errors: {
      ...
      githubSearch: "تعذر البحث في GitHub",
      githubUnavailable: "البحث في مستودعات GitHub غير متاح",
      directoryNotFound: "المجلد غير موجود",
      add: "تعذرت إضافة المشروع",
      clone: "تعذر استنساخ المستودع",
      nameRequired: "أدخل اسم مجلد من دون شرطات مائلة",
      create: "تعذر إنشاء المجلد",
    },
    titles: {
      host: "اختر جهازًا مضيفًا",
      method: "كيف تريد إضافته؟",
      directory: "ابحث عن مجلد",
      github: "اختر مستودع GitHub",
      destination: "اختر الوجهة",
      parent: "اختر المجلد الأصل",
      name: "سمِّ المجلد الجديد",
      addHost: "إضافة جهاز مضيف",
    },
    placeholders: {
      host: "البحث في الأجهزة…",
      method: "البحث في الطرق…",
      directory: "أدخل مسارًا أو ابحث في المجلدات…",
      github: "ابحث في GitHub أو أدخل owner/repo…",
      parent: "البحث في المجلدات الأصل…",
      name: "اسم المجلد",
    },
    methods: {
      directory: { label: "البحث عن مجلد", description: "ابحث عن مجلد على {{host}}" },
      browse: { label: "استعراض", description: "اختر مجلدًا محليًا" },
      github: {
        label: "استنساخ من GitHub",
        update: "حدّث هذا الجهاز لاستنساخ مستودعات GitHub",
        search: "ابحث في مستودعات GitHub الخاصة بك",
        enter: "أدخل رابط المستودع أو owner/repo",
      },
      newDirectory: {
        label: "مجلد جديد",
        description: "أنشئ مشروعًا فارغًا على {{host}}",
        update: "حدّث هذا الجهاز لإنشاء المجلدات",
      },
    },
    repository: {
      url: "رابط المستودع",
      cloneVia: "استنساخ عبر {{protocol}}",
      via: "{{repository}} عبر {{protocol}}",
    },
    destination: {
      exists: "موجود بالفعل",
      parent: "المجلد الأصل: {{parent}}",
      useParent: "استخدام هذا المجلد الأصل",
    },
    hints: { navigate: "تنقل", select: "تحديد", back: "رجوع", close: "إغلاق" },
  },
  projectPicker: {
