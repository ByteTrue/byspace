...
export const ar: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "الأرشيف غير متاح هنا لأنه لم يتم إنشاء مساحة العمل هذه كشجرة عمل BySpace",
  ...
  sidebar: {
    ...
    workspace: {
      ...
      toasts: {
        ...
        agentRenamePromptCopied: "تم نسخ النص. ألصقه في Agent الأكثر فهمًا لمساحة العمل هذه.",
        agentRenamePromptCopyFailed: "تعذر نسخ النص",
        hostDisconnected: "Host غير متصل",
  ...
  settings: {
    ...
    host: {
      ...
      dataRelay: {
        title: "مُرحّل البيانات",
        cardTitle: "Data Relay",
        description: "توجيه حركة مرور خدمات الويب الخاصة والمشفرة بين المضيفين.",
        statusNotConfigured: "غير مُهيأ",
        statusHosting: "يستضيف المُرحّل",
        statusConnected: "متصل بالمُرحّل",
        summaryHosting: "استضافة مُرحّل البيانات على {{listen}}",
        summaryConnected: "متصل بمُرحّل البيانات على {{endpoint}}",
        setup: "إعداد مُرحّل البيانات",
        editConfig: "تعديل الإعدادات",
        modalTitle: "إعداد مُرحّل البيانات",
        modalDescription:
          "قم بإعداد مُرحّل البيانات على {{host}} لتوجيه خدمات التطوير الخاصة بأمان دون توجيه المنافذ.",
        modeHost: "استضافة مُرحّل",
        modeClient: "الاتصال بمُرحّل",
        modeHostHint: "تشغيل خادم مُرحّل بيانات معزول على هذا المضيف.",
        modeClientHint: "قم بتوصيل هذا المضيف بخادم مُرحّل بيانات موجود مسبقًا.",
        listenLabel: "عنوان الاستماع المحلي",
        listenHint: "منفذ TCP للاستماع المخصص (مثل 127.0.0.1:8788).",
        listenRequired: "عنوان الاستماع مطلوب عند الاستضافة.",
        publicEndpointLabel: "نقطة النهاية العامة (اختياري)",
        publicEndpointHint:
          "العنوان العام المكشوف عبر النفق أو الوكيل (مثل relay.example.com:443).",
        connectLocallyTitle: "الاتصال محليًا",
        connectLocallyHint: "توصيل هذا المضيف تلقائيًا بالمُرحّل المحلي.",
        endpointLabel: "نقطة نهاية المُرحّل",
        endpointHint: "عنوان المُرحّل (مثل relay.example.com:443).",
        endpointRequired: "نقطة نهاية المُرحّل مطلوبة.",
        useTlsTitle: "استخدام TLS / WSS",
        useTlsHint: "تمكين التشفير للاتصالات عن بُعد.",
        accessTokenLabel: "رمز الوصول (Access token)",
        accessTokenPlaceholder: "أدخل أو أنشئ رمز وصول سري",
        accessTokenHint: "سر مشترك بين جميع خوادم daemon المشاركة.",
        tokenRequired: "رمز الوصول مطلوب.",
        generateToken: "إنشاء",
        tokenGenerated: "تم إنشاء رمز وصول جديد",
        tokenCopied: "تم نسخ رمز الوصول إلى الحافظة",
        disable: "تعطيل مُرحّل البيانات",
        disableConfirmTitle: "هل تريد تعطيل مُرحّل البيانات؟",
        disableConfirmMessage: "سيتم إغلاق اتصالات خدمات الويب النشطة عبر هذا المُرحّل.",
        saveAndApply: "حفظ وتطبيق",
        saveSuccess: "تم حفظ إعدادات مُرحّل البيانات",
        disabledSuccess: "تم تعطيل مُرحّل البيانات",
      },
      remoteWebServices: {
        title: "خدمات الويب البعيدة",
        summary: "خدمات خاصة",
        description: "يمكنك الوصول إلى خدمات الويب المحلية على مضيف آخر عبر مُرحّل البيانات الخاص.",
        add: "إضافة خدمة",
        loading: "جارٍ تحميل الخدمات…",
        disconnected: "اتصل بهذا المضيف لإدارة خدمات الويب البعيدة.",
        empty: "لا توجد خدمات ويب بعيدة بعد.",
        noOtherHosts:
          "لا توجد مضيفات أخرى متصلة. قم بتوصيل مضيف آخر بـ BySpace للوصول إلى خدماته الخاصة.",
        noCompatibleTargets: "اتصل بمضيف آخر مُحدّث تم إعداد مُرحّل البيانات عليه.",
        relayNotConfigured: "أعدّ مُرحّل البيانات على هذا المضيف قبل إضافة الخدمات.",
        updateHost: "حدّث هذا المضيف لاستخدام خدمات الويب البعيدة",
        updateHostHint: "تتطلب هذه الميزة إصدارًا أحدث من daemon.",
        addTitle: "إضافة خدمة ويب بعيدة",
        addHint: "أنشئ عنوان .remote.localhost ثابتًا على {{source}}.",
        nameLabel: "الاسم",
        namePlaceholder: "home-web",
        targetLabel: "المضيف الهدف",
        noTargets: "لا توجد مضيفات متوافقة",
        portLabel: "المنفذ الهدف",
        portHint: "منفذ HTTP المحلي على المضيف الهدف.",
        nameRequired: "الاسم مطلوب.",
        targetRequired: "اختر مضيفًا هدفًا.",
        invalidPort: "أدخل منفذًا من 1 إلى 65535.",
        presets: "إعدادات سريعة",
        previewLabel: "معاينة العنوان",
        copyUrl: "نسخ الرابط",
        openUrl: "فتح في المتصفح",
        open: "فتح",
    ...
    providers: {
      ...
      terminal: {
        sectionTitle: "الطرفية",
        activityTitle: "نشاط الطرفية",
        activityLabel: "الإبلاغ عن حالة الوكيل",
        activityHint: "يعرض وقت تشغيل واجهة الوكيل أو انتظارها للإدخال",
        legacyActivityLabel: "الإبلاغ عن حالة جميع واجهات الوكلاء",
        legacyActivityHint: "يدعم هذا المضيف إعداد نشاط مشتركًا واحدًا فقط",
        launchProfiles: "ملفات تعريف التشغيل",
        addProfile: "إضافة ملف تعريف",
        profileActions: "إجراءات {{name}}",
        otherProfiles: "ملفات تعريف طرفية أخرى",
        otherProfilesHint: "{{count}} ملفات تعريف غير مرتبطة بموفر",
        updateError: "تعذر تحديث نشاط الطرفية",
      },
      title: "مقدمي الخدمات",
