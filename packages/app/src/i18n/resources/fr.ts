...
export const fr: TranslationResources = {
  ...
  newWorkspace: {
    ...
    refPicker: {
      ...
      updateHost: "Mettez à jour l’hôte pour utiliser cette fonctionnalité.",
  ...
  addProjectFlow: {
    accessibility: "Ajouter un projet : {{page}}",
    back: "Retour",
    ...
    errors: {
      ...
      githubSearch: "Impossible de rechercher sur GitHub",
      githubUnavailable: "La recherche de dépôts GitHub est indisponible",
      directoryNotFound: "Dossier introuvable",
      add: "Impossible d’ajouter le projet",
      clone: "Impossible de cloner le dépôt",
      nameRequired: "Saisissez un nom de dossier sans barre oblique",
      create: "Impossible de créer le dossier",
    },
    titles: {
      host: "Choisir un hôte",
      method: "Comment voulez-vous l’ajouter ?",
      directory: "Rechercher un dossier",
      github: "Choisir un dépôt GitHub",
      destination: "Choisir la destination",
      parent: "Choisir le dossier parent",
      name: "Nommer le nouveau dossier",
      addHost: "Ajouter un hôte",
    },
    placeholders: {
      host: "Rechercher des hôtes…",
      method: "Rechercher des méthodes…",
      directory: "Saisissez un chemin ou recherchez des dossiers…",
      github: "Recherchez sur GitHub ou saisissez owner/repo…",
      parent: "Rechercher des dossiers parents…",
      name: "Nom du dossier",
    },
    methods: {
      directory: {
      ...
      browse: { label: "Parcourir", description: "Choisir un dossier local" },
      github: {
        label: "Cloner depuis GitHub",
        update: "Mettez à jour cet hôte pour cloner des dépôts GitHub",
        search: "Rechercher vos dépôts GitHub",
        enter: "Saisissez une URL de dépôt ou owner/repo",
      },
      newDirectory: {
        label: "Nouveau dossier",
        description: "Créer un projet vide sur {{host}}",
        update: "Mettez à jour cet hôte pour créer des dossiers",
      },
    },
    repository: {
      url: "URL du dépôt",
      cloneVia: "Cloner via {{protocol}}",
      via: "{{repository}} via {{protocol}}",
    },
    destination: {
      exists: "Existe déjà",
      parent: "Dossier parent : {{parent}}",
      useParent: "Utiliser ce dossier parent",
    },
    hints: { navigate: "Naviguer", select: "Sélectionner", back: "Retour", close: "Fermer" },
  },
  projectPicker: {
