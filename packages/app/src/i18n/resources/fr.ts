  ...
  settings: {
    ...
    providers: {
      ...
      terminal: {
        ...
        defaultShell: {
          sectionTitle: "Terminal par défaut",
          label: "Shell par défaut",
          hint: "Utilisé lors de la création d’un nouveau Terminal sans profil",
          accessibilityLabel: "Shell par défaut : {{value}}",
          saving: "Enregistrement...",
          options: {
            systemDefault: "Valeur système",
            powerShell7: "PowerShell 7 (pwsh.exe)",
