...
export const ptBR: TranslationResources = {
  ...
  newWorkspace: {
    ...
    refPicker: {
      ...
      updateHost: "Atualize o host para usar este recurso.",
  ...
  addProjectFlow: {
    accessibility: "Adicionar projeto: {{page}}",
    back: "Voltar",
    openPath: "Abrir caminho",
    loading: "Carregando…",
    progress: {
      clone: "Clonando repositório…",
      create: "Criando diretório…",
      add: "Adicionando projeto…",
    },
    empty: {
    ...
    errors: {
      ...
      githubSearch: "Não foi possível pesquisar no GitHub",
      githubUnavailable: "A busca de repositórios do GitHub está indisponível",
      directoryNotFound: "Diretório não encontrado",
      add: "Não foi possível adicionar o projeto",
      clone: "Não foi possível clonar o repositório",
      nameRequired: "Informe um nome de diretório sem barras",
      create: "Não foi possível criar o diretório",
    },
    titles: {
      host: "Escolha um host",
      method: "Como deseja adicionar?",
      directory: "Encontre um diretório",
      github: "Escolha um repositório do GitHub",
      destination: "Escolha o destino",
      parent: "Escolha o diretório pai",
      name: "Nomeie o novo diretório",
      addHost: "Adicionar host",
    },
    placeholders: {
      host: "Pesquisar hosts…",
      method: "Pesquisar métodos…",
      directory: "Digite um caminho ou pesquise diretórios…",
      github: "Pesquise no GitHub ou informe owner/repo…",
      parent: "Pesquisar diretórios pai…",
    ...
    methods: {
      ...
      browse: { label: "Procurar", description: "Escolher um diretório local" },
      github: {
        label: "Clonar do GitHub",
        update: "Atualize este host para clonar repositórios do GitHub",
        search: "Pesquisar seus repositórios do GitHub",
        enter: "Informe a URL do repositório ou owner/repo",
      },
      newDirectory: {
        label: "Novo diretório",
        description: "Criar um projeto vazio em {{host}}",
        update: "Atualize este host para criar diretórios",
      },
    },
    repository: {
      url: "URL do repositório",
      cloneVia: "Clonar via {{protocol}}",
      via: "{{repository}} via {{protocol}}",
    },
    destination: {
      exists: "Já existe",
      parent: "Diretório pai: {{parent}}",
      useParent: "Usar este diretório pai",
    },
    hints: { navigate: "Navegar", select: "Selecionar", back: "Voltar", close: "Fechar" },
  },
  projectPicker: {
