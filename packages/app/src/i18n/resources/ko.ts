...
const koTranslations = {
  ...
  portForwarding: {
    ...
    auto: "자동",
    start: "포워딩 시작",
    needTwoHosts: "연결된 호스트 두 대가 필요합니다",
    needTwoHostsDescription: "포트 포워딩을 사용하려면 두 호스트를 업데이트하고 연결하세요.",
    activeForwards: "활성 포워딩",
    noActiveForwards: "활성 포워딩 없음",
    copyAddress: "주소 복사",
    stop: "포워딩 중지",
    status: {
      active: "활성",
    ...
    errors: {
      hostRequired: "호스트를 선택하세요.",
      hostsMustDiffer: "다른 대상 호스트를 선택하세요.",
      invalidPort: "1에서 65535 사이의 포트를 입력하세요.",
      sourceUnavailable: "소스 호스트의 연결이 끊겼습니다. 다시 연결한 후 다시 시도하세요.",
      targetUnavailable: "대상 호스트의 연결이 끊겼습니다. 다시 연결한 후 다시 시도하세요.",
      updateRequired: "포트 포워딩을 사용하려면 두 호스트를 업데이트하세요.",
      relayDisabled: "대상 호스트에서 Relay를 활성화한 후 다시 시도하세요.",
      invalidOffer: "대상 호스트가 잘못된 페어링 정보를 반환했습니다.",
      startFailed: "포워딩을 시작하지 못했습니다. 두 호스트를 확인한 후 다시 시도하세요.",
      copyFailed: "주소를 복사하지 못했습니다. 다시 시도하세요.",
      stopFailed: "포워딩을 중지하지 못했습니다. 다시 시도하세요.",
    },
  },
  agentList: {
    fallbackTitle: "새 세션",
