...
const koTranslations = {
  ...
  settings: {
    ...
    providers: {
      ...
      terminal: {
        sectionTitle: "터미널",
        activityTitle: "터미널 활동",
        activityLabel: "에이전트 상태 보고",
        activityHint: "에이전트 CLI 실행 또는 입력 대기 상태를 표시합니다",
        legacyActivityLabel: "모든 에이전트 CLI 상태 보고",
        legacyActivityHint: "이 호스트는 하나의 공유 터미널 활동 설정만 지원합니다",
        launchProfiles: "시작 프로필",
        addProfile: "프로필 추가",
        profileActions: "{{name}} 작업",
        otherProfiles: "기타 터미널 프로필",
        otherProfilesHint: "프로바이더에 연결되지 않은 프로필 {{count}}개",
        defaultShell: {
          sectionTitle: "기본 터미널",
          label: "기본 Shell",
          hint: "프로필 없이 새 Terminal을 만들 때 사용합니다",
          accessibilityLabel: "기본 Shell: {{value}}",
          saving: "저장 중...",
          options: {
            systemDefault: "시스템 기본값",
        ...
        updateError: "터미널 활동을 업데이트할 수 없습니다",
      },
      diagnostic: {
        title: "진단",
        button: "진단",
