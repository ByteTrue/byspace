  ...
  settings: {
    ...
    host: {
      ...
      orchestration: {
        ...
        skills: {
          title: "오케스트레이션 스킬",
          installHint: "지원되는 코딩 에이전트에 BySpace 번들 스킬 설치",
          installedHint: "이 호스트에 설치되었으며 최신 상태입니다",
          updateHint: "설치된 스킬이 현재 BySpace 버전과 다릅니다",
          updateHost: "오케스트레이션 스킬을 관리하려면 호스트를 업데이트하세요",
          install: "설치",
          update: "업데이트",
          uninstall: "제거",
          saving: "저장 중...",
          manage: "관리",
          save: "저장",
          modalTitle: "오케스트레이션 스킬",
          targetsTitle: "설치 대상 환경",
          targetAgents: "~/.agents/skills (OpenCode, Codex, Pi 등)",
          targetAgentsDesc: "Pi, OpenCode, Codex 및 기타 에이전트용 표준 스킬 디렉토리",
          targetClaude: "~/.claude/skills (Claude Code)",
          targetClaudeDesc: "Claude Code용 스킬 디렉토리",
          skillsTitle: "설치할 스킬",
          selectAll: "전체 선택",
          deselectAll: "전체 해제",
          noTargetSelected: "하나 이상의 설치 대상을 선택하세요.",
          noSkillSelected: "하나 이상의 스킬을 선택하세요.",
          descriptions: {
            byspace: "BySpace CLI 및 워크스페이스 도구",
            "byspace-advisor": "세컨드 오피니언 어드바이저 에이전트",
            "byspace-committee": "2 에이전트 위원회 기획",
            "byspace-handoff": "컨텍스트 인수인계 에이전트",
            "byspace-project-setup": "프로젝트 및 byspace.json 설정",
          },
          installConfirmTitle: "오케스트레이션 스킬을 설치하거나 업데이트할까요?",
          installConfirmMessage:
            "BySpace 번들 스킬을 이 호스트에 동기화합니다. 다른 스킬은 변경되지 않으며, 관리되지 않는 충돌 복사본은 보존됩니다.",
          updateConfirmTitle: "오케스트레이션 스킬을 업데이트할까요?",
          updateConfirmMessage:
            "BySpace가 관리하는 복사본을 이 버전에 번들된 스킬로 교체합니다. 다른 스킬은 변경되지 않습니다.",
          uninstallConfirmTitle: "오케스트레이션 스킬을 제거할까요?",
          uninstallConfirmMessage:
            "이 호스트에서 수정되지 않은 관리 복사본을 제거합니다. 수정된 복사본은 보존됩니다.",
          errorTitle: "오케스트레이션 스킬을 관리할 수 없습니다",
          unknownError: "알 수 없는 오류",
        },
        systemPrompt: {
          title: "시스템 프롬프트",
