...
export const ja: TranslationResources = {
  ...
  workspace: {
    ...
    fileActions: {
      ...
      download: "ダウンロード",
      addToChat: "チャットに追加",
      focusChatFirst: "ファイルを追加する前にチャットタブを選択してください",
  ...
  panels: {
    ...
    file: {
      ...
      editor: {
        ...
        accessibilityLabel: "{{filename}} のソースエディター",
        saved: "保存済み",
  ...
  settings: {
    ...
    host: {
      ...
      dataRelay: {
        ...
        description:
          "ホスト間で暗号化されたプライベート Web サービスと開発トラフィックをルーティングします。",
        statusNotConfigured: "未設定",
        statusHosting: "リレーホスト中",
        statusConnected: "リレーに接続済み",
        summaryHosting: "{{listen}} で Data Relay をホスト中",
        summaryConnected: "{{endpoint}} の Data Relay に接続済み",
        setup: "データリレーを設定",
        editConfig: "設定を変更",
        modalTitle: "データリレーの設定",
        modalDescription:
          "{{host}} でデータリレーを設定し、ポート開放なしでホスト間の開発サービスにアクセスします。",
        modeHost: "リレーをホストする",
        modeClient: "既存のリレーに接続",
        modeHostHint: "このホストで隔離された Data Relay サーバーを実行します。",
        modeClientHint: "別のマシンや VPS で実行中の Data Relay に接続します。",
        listenLabel: "ローカルリスンアドレス",
        listenHint: "Data Relay 専用の TCP ポート（例: 127.0.0.1:8788）。",
        listenRequired: "ホストする場合はリスンアドレスが必要です。",
        publicEndpointLabel: "パブリックエンドポイント（任意）",
        publicEndpointHint:
          "トンネルやプロキシ経由で公開されるアドレス（例: relay.example.com:443）。",
        connectLocallyTitle: "ローカルでこのリレーに接続",
        connectLocallyHint: "このホストを自動的にローカルリレーに接続します。",
        endpointLabel: "リレーエンドポイント",
        endpointHint: "リレーの host:port（例: relay.example.com:443）。",
        endpointRequired: "リレーエンドポイントは必須です。",
        useTlsTitle: "TLS / WSS を使用",
        useTlsHint: "安全なリモート WebSocket 接続のために TLS を有効化します。",
        accessTokenLabel: "アクセストークン",
        accessTokenPlaceholder: "シークレットアクセストークンを入力または生成",
        accessTokenHint: "参加するすべてのデーモン間で共有する秘密鍵。",
        tokenRequired: "アクセストークンは必須です。",
        generateToken: "生成",
        tokenGenerated: "新しいアクセストークンを生成しました",
        tokenCopied: "アクセストークンをクリップボードにコピーしました",
        disable: "データリレーを無効化",
        disableConfirmTitle: "データリレーを無効化しますか？",
        disableConfirmMessage: "このリレー経由のアクティブな接続はすべて閉じられます。",
        saveAndApply: "保存して適用",
        saveSuccess: "データリレーの設定を保存しました",
        disabledSuccess: "データリレーを無効化しました",
      },
      remoteWebServices: {
        title: "リモート Web サービス",
        summary: "プライベートサービス",
        description:
          "プライベートデータリレー経由で別のホストのループバック Web サービスにアクセスします。",
        add: "サービスを追加",
        loading: "サービスを読み込み中…",
        disconnected: "リモート Web サービスを管理するには、このホストに接続してください。",
        empty: "リモート Web サービスはまだありません。",
        noOtherHosts:
          "他のホストが接続されていません。BySpace に別のホストを接続してプライベートサービスにアクセスしてください。",
        noCompatibleTargets: "データリレーが設定された更新済みの別のホストに接続してください。",
        relayNotConfigured: "サービスを追加する前に、このホストでデータリレーを設定してください。",
        updateHost: "リモート Web サービスを使用するには、このホストを更新してください",
        updateHostHint: "この機能には新しいバージョンのデーモンが必要です。",
        addTitle: "リモート Web サービスを追加",
        addHint: "{{source}} に固定の .remote.localhost アドレスを作成します。",
        nameLabel: "名前",
        namePlaceholder: "home-web",
        targetLabel: "対象ホスト",
        noTargets: "互換性のあるホストがありません",
        portLabel: "対象ポート",
        portHint: "対象ホストのループバック HTTP ポートです。",
        nameRequired: "名前を入力してください。",
        targetRequired: "対象ホストを選択してください。",
        invalidPort: "1～65535 のポートを入力してください。",
        presets: "クイックプリセット",
        previewLabel: "アドレスプレビュー",
        copyUrl: "URLをコピー",
        openUrl: "ブラウザで開く",
        open: "開く",
        urlCopied: "サービスURLをクリップボードにコピーしました",
        creating: "作成中…",
        create: "サービスを作成",
    ...
    providers: {
      ...
      terminal: {
        sectionTitle: "ターミナル",
        activityTitle: "ターミナルのアクティビティ",
        activityLabel: "エージェントの状態を報告",
        activityHint: "このエージェント CLI の実行中・入力待ち状態を表示します",
        legacyActivityLabel: "すべてのエージェント CLI の状態を報告",
        legacyActivityHint: "このホストは共有のアクティビティ設定のみ対応しています",
        launchProfiles: "起動プロファイル",
        addProfile: "プロファイルを追加",
        profileActions: "{{name}} の操作",
        otherProfiles: "その他のターミナルプロファイル",
        otherProfilesHint: "プロバイダーに関連付けられていないプロファイル: {{count}} 件",
        updateError: "ターミナルのアクティビティを更新できません",
      },
      title: "プロバイダー",
