  ...
  settings: {
    ...
    host: {
      ...
      daemon: {
        ...
        network: {
          sectionTitle: "ネットワーク",
          unavailable: "このホストに接続するとネットワーク設定を管理できます",
          saveError: "ネットワーク設定を更新できませんでした",
          restartHint: "ネットワーク変更の反映には daemon の再起動が必要です",
          restartPrompt: {
            title: "daemon を今すぐ再起動しますか？",
            message: "ネットワークの変更は再起動後に反映されます。アプリは自動的に再接続します。",
            confirm: "今すぐ再起動",
            later: "後で",
            failedTitle: "daemon を再起動できませんでした",
          },
          password: {
            title: "アクセスパスワード",
            setHint: "設定済み — 他のデバイスからの接続にはパスワードが必要です",
            unsetHint: "未設定 — ネットワーク上のどのデバイスでもパスワードなしで接続できます",
            edit: "編集",
            sheetTitle: "アクセスパスワード",
            fieldLabel: "パスワード",
          ...
          allowLan: {
            title: "LAN 接続を許可",
            hint: "このネットワーク上のデバイスはポート {{port}} でこの daemon に接続できます",
