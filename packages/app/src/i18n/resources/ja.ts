...
export const ja: TranslationResources = {
  ...
  portForwarding: {
    ...
    auto: "自動",
    start: "転送を開始",
    needTwoHosts: "接続済みのホストが2台必要です",
    needTwoHostsDescription: "ポート転送を使用するには、両方のホストを更新して接続してください。",
    activeForwards: "有効な転送",
    noActiveForwards: "有効な転送はありません",
    ...
    errors: {
      hostRequired: "ホストを選択してください。",
      hostsMustDiffer: "別の転送先ホストを選択してください。",
      invalidPort: "1から65535までのポートを入力してください。",
      sourceUnavailable: "転送元ホストが切断されました。再接続してからもう一度お試しください。",
      targetUnavailable: "転送先ホストが切断されました。再接続してからもう一度お試しください。",
      updateRequired: "ポート転送を使用するには両方のホストを更新してください。",
      relayDisabled: "転送先ホストでRelayを有効にして、もう一度お試しください。",
      invalidOffer: "転送先ホストから無効なペアリング情報が返されました。",
      startFailed: "転送を開始できませんでした。両方のホストを確認してもう一度お試しください。",
      copyFailed: "アドレスをコピーできませんでした。もう一度お試しください。",
      stopFailed: "転送を停止できませんでした。もう一度お試しください。",
    },
  },
  agentList: {
