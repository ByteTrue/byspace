...
export const ja: TranslationResources = {
  ...
  newWorkspace: {
    ...
    refPicker: {
      ...
      updateHost: "この機能を使用するにはホストを更新してください。",
  ...
  addProjectFlow: {
    ...
    errors: {
      ...
      githubSearch: "GitHub を検索できません",
      githubUnavailable: "GitHub リポジトリ検索を利用できません",
      directoryNotFound: "ディレクトリが見つかりません",
      add: "プロジェクトを追加できません",
      clone: "リポジトリをクローンできません",
      nameRequired: "スラッシュを含まないディレクトリ名を入力してください",
      create: "ディレクトリを作成できません",
    },
    titles: {
      host: "ホストを選択",
      method: "追加方法を選択",
      directory: "ディレクトリを検索",
      github: "GitHub リポジトリを選択",
      destination: "保存先を選択",
      parent: "親ディレクトリを選択",
      name: "新しいディレクトリ名",
      addHost: "ホストを追加",
    ...
    placeholders: {
      host: "ホストを検索…",
      method: "方法を検索…",
      directory: "パスを入力またはディレクトリを検索…",
      github: "GitHub を検索または owner/repo を入力…",
      parent: "親ディレクトリを検索…",
      name: "ディレクトリ名",
    },
    methods: {
      ...
      browse: {
        label: "参照",
        description: "ローカルディレクトリを選択",
      },
      github: {
        label: "GitHub からクローン",
        update: "GitHub リポジトリをクローンするにはホストを更新してください",
        search: "GitHub リポジトリを検索",
        enter: "リポジトリ URL または owner/repo を入力",
      },
      newDirectory: {
        label: "新しいディレクトリ",
        description: "{{host}} に空のプロジェクトを作成",
        update: "ディレクトリを作成するにはホストを更新してください",
      },
    },
    repository: {
      url: "リポジトリ URL",
      cloneVia: "{{protocol}} でクローン",
      via: "{{repository}}（{{protocol}}）",
    },
    destination: {
      exists: "既に存在します",
      parent: "親ディレクトリ：{{parent}}",
      useParent: "この親ディレクトリを使用",
    },
    hints: {
      navigate: "移動",
      select: "選択",
