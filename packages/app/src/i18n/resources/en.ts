export const en = {
  ...
  portForwarding: {
    ...
    localPortHint: "Optional",
    auto: "Auto",
    start: "Start forward",
    needTwoHosts: "Two connected hosts are required",
    needTwoHostsDescription: "Update and connect both hosts to use port forwarding.",
    activeForwards: "Active forwards",
    noActiveForwards: "No active forwards",
    ...
    errors: {
      ...
      hostsMustDiffer: "Choose a different target host.",
      invalidPort: "Enter a port from 1 to 65535.",
      sourceUnavailable: "The source host is no longer connected. Reconnect it and try again.",
      targetUnavailable: "The target host is no longer connected. Reconnect it and try again.",
      updateRequired: "Update both hosts to use port forwarding.",
      relayDisabled: "Enable Relay on the target host and try again.",
      invalidOffer: "The target host returned an invalid pairing offer.",
      startFailed: "Could not start the forward. Check both hosts and try again.",
      copyFailed: "Could not copy the address. Try again.",
      stopFailed: "Could not stop the forward. Try again.",
    },
  },
  agentList: {
