export const en = {
  ...
  addProjectFlow: {
    ...
    errors: {
      ...
      githubSearch: "Unable to search GitHub",
      githubUnavailable: "GitHub repository search is unavailable",
      directoryNotFound: "Directory not found",
      add: "Unable to add project",
      clone: "Unable to clone repository",
      nameRequired: "Enter a directory name without slashes",
      create: "Unable to create directory",
    },
    titles: {
      host: "Choose a host",
      method: "How do you want to add it?",
      directory: "Find a directory",
      github: "Choose a GitHub repository",
      destination: "Choose destination",
      parent: "Choose parent directory",
      name: "Name the new directory",
      addHost: "Add a host",
    },
    placeholders: {
      host: "Search hosts…",
      method: "Search methods…",
      directory: "Type a path or search directories…",
      github: "Search GitHub or enter owner/repo…",
      parent: "Search parent directories…",
      name: "Directory name",
    },
    methods: {
      directory: {
      ...
      browse: {
        label: "Browse",
        description: "Pick a local directory",
      },
      github: {
        label: "Clone from GitHub",
        update: "Update this host to clone GitHub repositories",
        search: "Search your GitHub repositories",
        enter: "Enter a repository URL or owner/repo",
      },
      newDirectory: {
        label: "New directory",
        description: "Create an empty project on {{host}}",
        update: "Update this host to create directories",
      },
    },
    repository: {
      url: "Repository URL",
      cloneVia: "Clone via {{protocol}}",
