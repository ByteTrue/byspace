  ...
  settings: {
    ...
    host: {
      ...
      dataRelay: {
        ...
        description: "Route encrypted private web services and development traffic between hosts.",
        statusNotConfigured: "Not configured",
        statusHosting: "Hosting relay",
        statusConnected: "Connected to relay",
        summaryHosting: "Hosting Data Relay on {{listen}}",
        summaryConnected: "Connected to Data Relay at {{endpoint}}",
        setup: "Set up Data Relay",
        editConfig: "Configure",
        modalTitle: "Configure Data Relay",
        modalDescription:
          "Configure data-plane relay settings on {{host}} to route private development services across hosts without port forwarding.",
        modeHost: "Host a Relay",
        modeClient: "Connect to Relay",
        modeHostHint:
          "Run an isolated Data Relay server on this host. Other hosts will connect to this relay via your public endpoint or local network.",
        modeClientHint:
          "Connect this host to an existing Data Relay server running on another host or VPS.",
        listenLabel: "Local listen address",
        listenHint: "TCP host:port for the dedicated Data Relay listener (e.g. 127.0.0.1:8788).",
        listenRequired: "Local listen address is required when hosting.",
        publicEndpointLabel: "Public endpoint (optional)",
        publicEndpointHint:
          "Public host:port exposed via tunnel or reverse proxy (e.g. relay.example.com:443).",
        connectLocallyTitle: "Connect this host locally",
        connectLocallyHint: "Automatically connect this host to the local relay listener.",
        endpointLabel: "Relay endpoint",
        endpointHint: "Relay host:port (e.g. relay.example.com:443 or 127.0.0.1:8788).",
        endpointRequired: "Relay endpoint is required.",
        useTlsTitle: "Use TLS / WSS",
        useTlsHint: "Enable TLS for secure remote WebSocket relay connections.",
        accessTokenLabel: "Access token",
        accessTokenPlaceholder: "Enter or generate a secret access token",
        accessTokenHint: "Shared bearer secret required across all participating daemons.",
        tokenRequired: "Access token is required.",
        generateToken: "Generate",
        tokenGenerated: "New access token generated",
        tokenCopied: "Access token copied to clipboard",
        disable: "Disable Data Relay",
        disableConfirmTitle: "Disable Data Relay?",
        disableConfirmMessage:
          "Active remote web service connections through this relay will be closed.",
        saveAndApply: "Save & Apply",
        saveSuccess: "Data Relay configuration saved",
        disabledSuccess: "Data Relay disabled",
      },
      remoteWebServices: {
        title: "Remote web services",
        summary: "Private services",
        description:
        ...
        noOtherHosts:
          "No other hosts connected. Connect another host to BySpace to access its private web services.",
        noCompatibleTargets: "Connect another online host with Data Relay configured.",
        relayNotConfigured: "Configure Data Relay on this host before adding services.",
        updateHost: "Update this host to use Remote Web Services",
        updateHostHint: "This feature requires a newer daemon.",
        addTitle: "Add remote web service",
        addHint: "Create a stable .remote.localhost address on {{source}}.",
        nameLabel: "Name",
        namePlaceholder: "home-web",
        targetLabel: "Target host",
        noTargets: "No compatible hosts",
        portLabel: "Target port",
        portHint: "The loopback HTTP port on the target host.",
        nameRequired: "Name is required.",
        targetRequired: "Choose a target host.",
        ...
        open: "Open",
        urlCopied: "Service URL copied to clipboard",
        creating: "Creating…",
      ...
      orchestration: {
        ...
        skills: {
          ...
          installHint: "Manage bundled BySpace skills for supported coding agents",
          ...
          manage: "Manage",
          save: "Save",
          modalTitle: "Orchestration skills",
          targetsTitle: "Installation targets",
          targetAgents: "~/.agents/skills (OpenCode, Codex, Pi, etc.)",
          targetAgentsDesc: "Standard skills directory for Pi, OpenCode, Codex, and other agents",
          targetClaude: "~/.claude/skills (Claude Code)",
          targetClaudeDesc: "Skills directory for Claude Code",
          skillsTitle: "Skills to install",
          selectAll: "Select all",
          deselectAll: "Deselect all",
          noTargetSelected: "Please select at least one target environment.",
          noSkillSelected: "Please select at least one skill.",
          descriptions: {
            byspace: "BySpace CLI & workspace tools",
            "byspace-advisor": "Second-opinion advisory agent",
            "byspace-committee": "Two-agent committee planning",
            "byspace-handoff": "Task handoff to another agent",
            "byspace-project-setup": "Project & byspace.json setup",
          },
    ...
    providers: {
      ...
      terminal: {
        ...
        activityTitle: "Terminal activity",
        activityLabel: "Report agent status",
        activityHint: "Shows when this agent CLI is running or needs input",
        legacyActivityLabel: "Report status for all agent CLIs",
        legacyActivityHint: "This host only supports one shared Terminal activity setting",
        launchProfiles: "Launch profiles",
        addProfile: "Add profile",
        profileActions: "{{name}} actions",
        otherProfiles: "Other terminal profiles",
        otherProfilesHint: "{{count}} profiles not linked to a Provider",
        updateError: "Unable to update Terminal activity",
      },
