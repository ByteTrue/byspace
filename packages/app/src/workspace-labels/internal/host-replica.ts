import type { WorkspaceLabelDefinition } from "@bytetrue/protocol/workspace-labels";
import { workspaceLabelKey } from "@bytetrue/protocol/workspace-labels";
import type { WorkspaceLabelListPayload } from "@bytetrue/client/internal/daemon-client";
