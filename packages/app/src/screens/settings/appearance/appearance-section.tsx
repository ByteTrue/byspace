...
import { ICON_SIZE, PLUGIN_THEME_PREFERENCE, THEME_OPTIONS, type Theme } from "@/styles/theme";
...
// ---------------------------------------------------------------------------
// Font sizes (commit on blur/submit)
// ---------------------------------------------------------------------------
...
export function AppearanceSection() {
  ...
  // Live-while-typing: the in-progress size drafts drive the preview without
  // committing to the global theme.
  const previewOverrides = useMemo(
    () => ({
      contentFontSize: sizeDraftToOverride(contentSizeDraft),
      codeFontSize: sizeDraftToOverride(codeSizeDraft),
    }),
    [codeSizeDraft, contentSizeDraft],
  );
