...
import type { JsonValue } from "@byspace/protocol/agent-types";
import { getOpenAgentTabLabel } from "@byspace/protocol/agent-labels";
import {
  memo,
  useCallback,
  useEffect,
...
export const WorkspaceScreen = memo(function WorkspaceScreen({
  ...
  useEffect(() => {
    traceInstant("byspace.workspace.mount", { serverId, workspaceId });
    return () => {
      traceInstant("byspace.workspace.unmount", { serverId, workspaceId });
    };
