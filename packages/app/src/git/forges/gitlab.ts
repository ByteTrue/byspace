...
import type { CheckoutPipelineJob, CheckoutPrMergeMethod } from "@byspace/protocol/messages";
import {
  CHECK_TRAIT_ACTION_REQUIRED,
  CHECK_TRAIT_MANUAL,
  CHECK_TRAIT_WARNING,
} from "@byspace/protocol/check-traits";
import { GITLAB_ACTIVE_PIPELINE_STATUS_SET } from "@byspace/protocol/gitlab-pipeline";
