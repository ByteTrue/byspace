 ...
 * as before.
 */
import { FORGE_DEFINITIONS, getForgeDefinitionOrNeutral } from "@bytetrue/protocol/forge-manifest";
import { normalizeHost, parseGitRemoteLocation } from "@bytetrue/protocol/git-remote";
import type { ForgeAuthState } from "@bytetrue/protocol/messages";
import {
  buildForgeBlobUrl,
...
export interface ForgePresentation {
  ...
  /** Auth CLI binary for the install hint, or null for a forge with no BySpace-driven sign-in. */
