...
const TIMEOUT_ENV_KEY = "BYSPACE_SHELL_ENV_TIMEOUT_MS";
...
function resolveShellEnv({ deps, timeoutMs }: ResolveShellEnvInput): ResolvedShellEnv {
  ...
  delete shellEnv.BYSPACE_NODE_ENV;
  delete shellEnv.BYSPACE_DESKTOP_MANAGED;
  delete shellEnv.BYSPACE_SUPERVISED;
