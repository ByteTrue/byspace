export const CLIENT_CAPS = {
  // Clients outside the BySpace app version series can explicitly accept provider IDs.
  ...
  // COMPAT(customTimelineMessages): added in v0.13.X. The daemon omits custom_message
  // timeline items for older clients whose strict timeline union rejects them.
  // Remove after 2027-09-17 once the supported client floor is >= v0.13.X.
  customTimelineMessages: "custom_timeline_messages",
