export const CLIENT_CAPS = {
  // COMPAT(selectiveAgentTimeline): added in BySpace v0.1.2. Capable clients receive
  // agent streams only for their explicit viewed set. Remove after 2027-01-19
  // once the supported client floor is >= BySpace v0.1.2.
  ...
  // COMPAT(projectUpdates): added in BySpace v0.1.2, remove gate after 2027-01-18.
