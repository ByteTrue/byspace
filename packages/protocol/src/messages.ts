  ...
  .object({
    ...
    features: z
      .object({
        ...
        // byspace advertises pairing independently because its Go daemon does not
        // claim the broader legacy daemon-status RPC surface.
        pairingOfferRpc: z.boolean().optional(),
