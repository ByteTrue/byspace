...
try {
  ...
  // Test 11: byspace --help shows worktree subcommand
  {
    console.log("Test 11: byspace --help shows worktree subcommand");
    ...
    console.log("✓ byspace --help shows worktree subcommand\n");
  }
} finally {
