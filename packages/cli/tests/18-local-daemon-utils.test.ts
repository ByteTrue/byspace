...

{
  ...
  assert.strictEqual(resolveTcpHostFromListen("6777"), "127.0.0.1:6777");
...

{
  ...
  assert.strictEqual(resolveTcpHostFromListen("localhost:6777"), "localhost:6777");
...

{
  ...
  assert.strictEqual(resolveTcpHostFromListen("/tmp/byspace.sock"), null);
  assert.strictEqual(resolveTcpHostFromListen("unix:///tmp/byspace.sock"), null);
  assert.strictEqual(resolveTcpHostFromListen("pipe://\\\\.\\pipe\\byspace-managed-test"), null);
  assert.strictEqual(resolveTcpHostFromListen("\\\\.\\pipe\\byspace-managed-test"), null);
...

{
  ...
  assert.strictEqual(resolveTcpHostFromListen("C:\\Users\\foo\\.byspace\\byspace.sock"), null);
  assert.strictEqual(resolveTcpHostFromListen("D:\\project\\socket"), null);
  assert.strictEqual(resolveTcpHostFromListen("C:\\byspace.sock"), null);
