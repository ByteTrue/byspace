...
describe("buildWorkspaceServiceEnv", () => {
  ...
  it("builds default branch self and service URLs", () => {
    expect(
      ...
      HOST: "127.0.0.1",
      BYSPACE_PORT: "5173",
      BYSPACE_URL: "http://daemon--byspace.localhost:6767",
      BYSPACE_SERVICE_DAEMON_PORT: "5173",
      BYSPACE_SERVICE_DAEMON_URL: "http://daemon--byspace.localhost:6767",
    });
  });
  ...
  it("builds feature branch self and service URLs", () => {
    expect(
      ...
      HOST: "127.0.0.1",
      BYSPACE_PORT: "5173",
      BYSPACE_URL: "http://daemon--feature-x--byspace.localhost:6767",
      BYSPACE_SERVICE_DAEMON_PORT: "5173",
      BYSPACE_SERVICE_DAEMON_URL: "http://daemon--feature-x--byspace.localhost:6767",
    });
  });
  ...
  it("adds peer service ports and URLs", () => {
    expect(
      ...
      HOST: "127.0.0.1",
      BYSPACE_PORT: "5173",
      BYSPACE_URL: "http://web--feature-x--byspace.localhost:6767",
      BYSPACE_SERVICE_API_PORT: "4000",
      BYSPACE_SERVICE_API_URL: "http://api--feature-x--byspace.localhost:6767",
      BYSPACE_SERVICE_WEB_PORT: "5173",
      BYSPACE_SERVICE_WEB_URL: "http://web--feature-x--byspace.localhost:6767",
    });
  });
