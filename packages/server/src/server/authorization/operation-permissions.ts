...
const INBOUND_PERMISSION = {
  ...
  "collab.slice.create.request": "workspace.write",
  "collab.slice.list.request": "workspace.read",
...
const OUTBOUND_PERMISSION = {
  ...
  "collab.slice.create.response": "workspace.write",
  "collab.slice.list.response": "workspace.read",
