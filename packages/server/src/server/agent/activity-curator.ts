...
import type { AgentAttachment } from "@bytetrue/protocol/messages";
import type { AgentTimelineRow } from "./agent-timeline-store-types.js";
import { isLikelyExternalToolName } from "@bytetrue/protocol/tool-name-normalization";
import { buildToolCallDisplayModel } from "@bytetrue/protocol/tool-call-display";
...
function buildForkContextText(input: {
  ...
  const header = ["Chat history from a previous BySpace agent."];
