...
function buildFeatureProviderInputs(params: {
  ...
  const voiceModeEnabled = resolveOptionalBooleanFlag(
    firstSpeechDefinedValue<string | boolean>([
      params.env.BYSPACE_VOICE_MODE_ENABLED,
  ...
  return {
    ...
    voiceTurnDetection: {
      configuredValue: firstSpeechDefinedValue<string>([
        params.env.BYSPACE_VOICE_TURN_DETECTION_PROVIDER,
    ...
    voiceStt: {
      configuredValue: firstSpeechDefinedValue<string>([
        params.env.BYSPACE_VOICE_STT_PROVIDER,
    ...
    voiceTts: {
      configuredValue: firstSpeechDefinedValue<string>([
        params.env.BYSPACE_VOICE_TTS_PROVIDER,
...
export function resolveSpeechConfig(params: {
  ...
  openai: BySpaceOpenAIConfig | undefined;
  ...
  const local = resolveLocalSpeechConfig({
    byspaceHome: params.byspaceHome,
    env: params.env,
    persisted: params.persisted,
    providers,
  });
