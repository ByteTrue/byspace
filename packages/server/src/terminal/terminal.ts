...
import { TerminalInputModeTracker } from "@bytetrue/protocol/terminal-input-mode";
...
const BYSPACE_CLI_BIN_ENTRIES = ["@bytetrue/byspace/bin/byspace", "@bytetrue/cli/bin/byspace"];
