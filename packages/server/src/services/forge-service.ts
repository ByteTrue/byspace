import type { ForgeSearchKind } from "@bytetrue/byspace-protocol/messages";
...
export function normalizeForgeSearchKinds(
  ...
  return kinds.map((kind) => {
    // COMPAT(githubSearchKind): added in BySpace v0.1.2, remove with the legacy
    // github_search_request RPC after 2027-01-18.
...
export interface SearchResult {
  ...
  /**
   * COMPAT(githubFeaturesEnabled): added in BySpace v0.1.2, remove after 2027-01-18.
   */
