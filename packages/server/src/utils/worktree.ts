...
import { BySpaceConfigSchema, type BySpaceConfig } from "@byspace/protocol/byspace-config-schema";
import {
...
export { slugify, validateBranchSlug } from "@byspace/protocol/branch-slug";
