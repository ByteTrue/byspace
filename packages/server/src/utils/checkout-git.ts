...
import { readBySpaceWorktreeMetadata } from "./worktree-metadata.js";
...
export async function getCheckoutSnapshotFacts(
  ...
  const storedBaseRef = inspected.byspaceWorktree.isBySpaceOwnedWorktree
    ? readBySpaceWorktreeBaseRef(inspected.byspaceWorktree.worktreeRoot)
    : null;
