...
```ts
import { createPaseoClient } from "@byspace/client";
...
The public API is the package root. Imports under `@byspace/client/internal/*` are unsupported implementation details used by Paseo's own packages.
