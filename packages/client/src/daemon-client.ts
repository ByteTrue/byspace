...
import { parsePluginSourceReference } from "@byspace/protocol/plugin-source-reference";
import {
...
export class DaemonClient {
  ...
  async appendAgentTimelineItem(
    agentId: string,
    item: Omit<import("@byspace/protocol/agent-types").PluginTimelineItem, "pluginId">,
