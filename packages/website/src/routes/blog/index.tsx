...
export const Route = createFileRoute("/blog/")({
  ...
  head: () =>
    pageMeta(
      "Blog – Updates and announcements from the BySpace team",
      "Product updates, technical posts, and announcements from the BySpace team. Notes on building a self-hosted, multi-agent dev environment for your phone.",
      "/blog",
    ),
  component: BlogIndex,
});
