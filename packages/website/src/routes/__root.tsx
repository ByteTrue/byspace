...
export const Route = createRootRoute({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "BySpace" },
      { property: "og:type", content: "website" },
      { property: "og:image", content: "https://byspace.cc.cd/og-image.png" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: "https://byspace.cc.cd/og-image.png" },
    ],
    links: [
