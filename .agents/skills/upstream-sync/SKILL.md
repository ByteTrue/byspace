...
6. Preserve intentional internal/upstream compatibility names unless the current code already migrated that boundary, including internal `@byspace/*`, protocol/RPC identities, and internal storage namespaces. Never perform a global search-and-replace rebrand.
