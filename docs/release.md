...
```bash
RELEASE_LOOKUP=$(node scripts/github-release.mjs --repo getpaseo/byspace --tag vX.Y.Z)
...
RELEASE_LOOKUP=$(node scripts/github-release.mjs --repo getpaseo/byspace --tag vX.Y.Z-beta.N)
