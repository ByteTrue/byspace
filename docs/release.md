...
9. Verify npm `beta`, `https://app-beta.byspace.cc.cd`, the Beta Worker deployment, a real Beta daemon pairing URL, and relay connection. Confirm npm `latest` and Stable deployment IDs did not move.
