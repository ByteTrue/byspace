...
- 独立 issue。
- 相关 spec：`codestable/spec/index.md`；Web + daemon 产品边界不变，Skill 文件操作仍由目标 Host 上的 Agent 执行。
...
- 毕业回写：当前产品能力与稳定兼容/交互边界已写入 `codestable/spec/index.md` 的“项目准备”章节；无需更新 Vision、notes、Agent 指令或 tools。
