...
- 独立性能 bug；Terminal 子路径关联 `codestable/epics/002-o-terminal-experience/spec.md`。
...
- 毕业回写：当前 stream 所有权不变量写入 `codestable/spec/index.md`、Terminal epic 与 `docs/terminal-performance.md`；调查过程、macOS 对照和未复现边界留在本 issue。
...
- Project Spec：`codestable/spec/index.md` 的 Terminal 当前真相。
- Epic Spec：`codestable/epics/002-o-terminal-experience/spec.md` 的方案、架构与验证边界。
