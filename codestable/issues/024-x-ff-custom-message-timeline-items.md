...
- 改动：
  - `packages/protocol/src/agent-types.ts`、`messages.ts`、`client-capabilities.ts` — 新 timeline 项 + wire schema + client cap（COMPAT(customTimelineMessages): added in v0.13.1, remove after 2027-09-17）
