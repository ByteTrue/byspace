---
kind: issue
title: "Local dictation model management"
type: feature
status: open
priority: high
created: 2026-08-04
...
- Talk: `codestable/talks/003-local-dictation-models.md`
- Existing speech truth: `codestable/spec/index.md` (`Architecture #632`, to be replaced on close)
