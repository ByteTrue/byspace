...
- 前序：`codestable/epics/002-o-terminal-experience/issues/013-x-terminal-emulator-remount-on-workspace-switch.md`（本 issue 的动因与实测数据在其中）
...
- epic：`codestable/epics/002-o-terminal-experience/spec.md` 已记录续传为当前方案并勾掉本 issue。
