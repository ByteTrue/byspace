...
- [ ] `issues/001-o-worker-domain-foundation.md` — worker 域地基设计与首批切片／**切片 001–002–004 已完成，003 待推进**／验证：实体与 schema、pi 装配、权限闸
...
**下一批：** 切片 003（项目组：绑 project 与 workspace、成员与协调者）、群聊与路由、目标与预算。前三项都依赖已完成的 001–002–004。

**UI 尚未开始。** 当前所有能力只能从代码调用：没有 RPC、没有路由、daemon 启动时不建库。可在 Epic 内直接推进的切片均已落库且可测，但**用户还看不到任何东西**。
