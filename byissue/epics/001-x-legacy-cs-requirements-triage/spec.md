...
- B01 最终采用双 Web App、单 Relay：prerelease 使用 `app-beta.byspace.cc.cd`，Stable 使用 `app.byspace.cc.cd`，两者统一使用 `relay.byspace.cc.cd:443`；Owner 于 2026-09-02 取消 Beta Relay。
