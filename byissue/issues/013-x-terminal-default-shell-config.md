...
**归属:** 独立 issue;相关真相 `byissue/spec/terminal.md`(输入与粘贴、快照恢复)、`docs/rpc-namespacing.md`、`docs/protocol-compatibility.md`。
...
- 回写:`byissue/spec/terminal.md` 增补“默认 shell”小节(shell 优先级、注入点、探测、UI 门控与 Auto 语义)
