...
This example implements the behavior proposed in upstream Paseo PR #3751 as a plugin. It recognizes
...
calls return `undefined`, leaving BySpace's original timeline entry unchanged.
...
the authoritative projected tail first. The renderer validates `data` before BySpace mounts the
component.
