...
Use the [BySpace public documentation](https://github.com/ByteTrue/byspace/tree/main/public-docs) as the current index. Select the page that owns the user's question and open its Markdown source before answering.

For troubleshooting, begin with the repository's current troubleshooting documentation and follow its links when the issue belongs to a more specific page. Prefer the ByteTrue repository documentation over memory. Answer the user directly, then link the relevant page as supporting documentation.
...
- Questions and workflow discussions: [GitHub Discussions](https://github.com/ByteTrue/byspace/discussions)
