...
LOCAL_MODELS_DIR="${BYSPACE_LOCAL_MODELS_DIR:-${BYSPACE_LOCAL_MODELS_DIR:-$HOME/.byspace/models/local-speech}}"
...
export BYSPACE_CORS_ORIGINS="${BYSPACE_CORS_ORIGINS:-${BYSPACE_CORS_ORIGINS:-*}}"
export BYSPACE_NODE_INSPECT="${BYSPACE_NODE_INSPECT:---inspect=0}"

SKIP_BUILD="${BYSPACE_SKIP_DEV_SERVER_BUILD:-${BYSPACE_SKIP_DEV_SERVER_BUILD:-0}}"
