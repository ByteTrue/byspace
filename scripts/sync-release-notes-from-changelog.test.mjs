...
function withTempChangelog(fn, changelogText = "## 0.1.60-beta.1 - 2026-04-20\n\n- Beta notes.\n") {
  ...
  const tempDir = mkdtempSync(path.join(tmpdir(), "byspace-release-notes-test-"));
...
test("converts contributor profile links to mentions in synced release notes", () => {
  const changelogText = [
    ...
    "",
    "- Beta notes. ([#526](https://github.com/ByteTrue/byspace/pull/526) by [@therainisme](https://github.com/therainisme))",
    "",
  ].join("\n");
