...
const relayEndpoint =
  args["relay-endpoint"] ?? process.env.PASEO_RELAY_ENDPOINT ?? "relay.byspace.cc.cd:443";
const baseUrl = args["base-url"] ?? process.env.PASEO_APP_URL ?? "https://app.byspace.cc.cd";
