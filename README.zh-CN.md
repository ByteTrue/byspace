...
从 [byspace.cc.cd/download](https://byspace.cc.cd/download) 或 [GitHub releases 页面](https://github.com/ByteTrue/byspace/releases)下载。打开 app 后 daemon 会自动启动，不需要再安装其他东西。
...
- [文档](https://byspace.cc.cd/docs)
- [配置参考](https://byspace.cc.cd/docs/configuration)
...
更多内容见[完整 CLI 参考](https://byspace.cc.cd/docs/cli)。
...
- `packages/website`：营销站点和文档（`byspace.cc.cd`）
...
- [ByteTrue/byspace-relay](https://github.com/ByteTrue/byspace-relay) — 官方分布式 relay，使用 Elixir 编写
- [byspace-skins](https://github.com/huangguang1999/byspace-skins) — BySpace 桌面端社区主题与零 patch 换肤工具，支持 Agent Skill
- [byspace-vscode](https://marketplace.visualstudio.com/items?itemName=hinnes.byspace-vscode) — VS Code 扩展
