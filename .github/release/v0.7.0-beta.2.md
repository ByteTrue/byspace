...
- Android APKs are signed with ByteTrue's release key. Certificate SHA-256: `9994bc2c7106a7245dd7f8f15d058653de8bfe896388decda43239271c685796`.
...
- `*-ios-simulator-*.app.zip` runs only in an iOS Simulator.
- `*-ios-unsigned.ipa` is not directly installable. You must re-sign it with your own Apple identity before sideloading. A free Personal Team profile normally expires after seven days.
