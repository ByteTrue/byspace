...
`.byspace/upstream-sync.json` 已记录 33/33 dispositions、16 笔 source→local mapping、5 笔 hardening，并把 cursor 推进到 `1977d330edefb8d7c8c0f0673e911586d40a6262`；`npm run upstream:check` 通过。
