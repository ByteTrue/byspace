...
Claude Code also works inside the BySpace terminal. If you prefer the standard CLI experience, open a terminal in your workspace and run `claude` as usual.
