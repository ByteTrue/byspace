...
`.byspace/workflows/discord-help.yml`:
...
Leading declared inputs follow the mention. Hub exposes the remaining text as `${{ byspace.prompt }}`. See [Workflows](/docs/hub/workflows).
