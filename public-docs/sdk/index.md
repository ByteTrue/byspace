...
`@getpaseo/client` is the upstream TypeScript library that drives a BySpace daemon from your own program. You pick a provider and model, give an agent a prompt and a directory, and wait for the answer.
