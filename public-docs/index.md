...
BySpace prints a pairing link. Open it in a browser to connect the hosted Web app at [app.byspace.cc.cd](https://app.byspace.cc.cd). The daemon can also serve the same browser UI itself; see [Self-hosting the web UI](/docs/web-ui).
