...
BySpace plugins add native workspace panels, Command Center items, global surfaces, app themes, daemon behavior, and composer attachment sources. They run on every BySpace client connected to the host, including mobile.
