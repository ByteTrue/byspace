...
Plugin UI runs on desktop, browser, iOS, and Android, across every BySpace theme. `theme` is a typed `PluginTheme`. Color and spacing must come from those props. Unstyled `Text` is black and fails in dark themes.
