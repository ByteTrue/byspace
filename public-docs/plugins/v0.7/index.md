...
> **For BySpace v0.7.x.** This is the current stable plugin API.
...
- [Plugin reference](/docs/plugins/v0.7/reference), add daemon behavior, use the BySpace SDK, contribute themes and attachments, and manage lifecycle.
