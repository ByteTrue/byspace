...
The examples below are a quick tour. The full, up-to-date reference is on GitHub: [docs/custom-providers.md](https://github.com/ByteTrue/byspace/blob/main/docs/custom-providers.md).
